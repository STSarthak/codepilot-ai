...
import com.sarthak.projects.codepilot_ai.service.DeploymentService;
...
public class KubernetesDeploymentServiceImpl implements DeploymentService {
    ...
    private static final String NAMESPACE = "codepilot-apps";
...
//        String domain = "project-" + projectId + ".app.domain.com";
        String domain = "project-" + projectId + ".localtest.me";
